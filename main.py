...
if pilihan1:
    ...
    pv = col_B.number_input("Present Value", key="fv_1") # NP
...
if pilihan3:
    ...
    yn :  str = st.text_input("Xn (tahun 1, tahun 2, tahun 3, ...)", key="nv_2")
    ...
    if runs:
        hasil, interpretasi = epd.NPV(xnn, ynn, r, hari, tahun)
        st.markdown("## Nilai") 
        st.write(hasil)
...
if pilihan4:
    ...
    fv = st.number_input("Future Value") # NP
    i = st.number_input("r")
    n = st.number_input("n")
